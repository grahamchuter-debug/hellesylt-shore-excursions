import schedulePayload from "@/data/hellesylt-cruise-schedules.generated.json";

export type HellesyltScheduleRow = {
  port: string;
  ship: string;
  cruise_line: string;
...
export type HellesyltScheduleEntry = {
  date: string;
  ship: string;
  arrival: string;
  departure: string;
...
type SchedulePayload = {
  ...
  rows: HellesyltScheduleRow[];
};

const payload = schedulePayload as SchedulePayload;

export const hellesyltScheduleIntegrity = payload.integrity;
export const hellesyltScheduleMeta = {
  port: payload.port,
...
function toEntry(row: HellesyltScheduleRow): HellesyltScheduleEntry {
  return {
...
export function getAllHellesyltRows(): HellesyltScheduleRow[] {
  return payload.rows;
}

export function getHellesyltEntries(): HellesyltScheduleEntry[] {
  return payload.rows.map(toEntry);
}

export function getHellesyltEntriesForMonthKey(monthKey: string): HellesyltScheduleEntry[] {
  return payload.rows
...
export function getHellesyltMonthSummaries() {
