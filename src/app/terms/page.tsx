...
export const metadata: Metadata = buildPageMetadata({
  title: "Terms of Use",
  description:
    "Terms of use for Hellesylt Shore Excursions: independent cruise planning information for Hellesylt port days.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <ContentPage
      title="Terms of Use"
      lead="These terms cover use of the Hellesylt Shore Excursions website as an independent informational planning resource."
      ...
      ctaTitle="Plan your Hellesylt cruise day"
      ctaText="Explore village, Mount Stranda and Briksdal options, then verify timings with your cruise line."
      ctaHref="/excursions"
    ...
    >
      <section>
        ...
        <p>
          ...
          information about Hellesylt. It is not a substitute for official cruise-line
      ...
      <section>
        ...
        <p>
          ...
          line. This site does not invent reposition logistics between ports.
        </p>
      </section>
