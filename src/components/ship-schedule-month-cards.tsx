...
import {
  ...
  type getHellesyltMonthSummaries,
} from "@/lib/hellesylt-schedules";

type MonthSummary = ReturnType<typeof getHellesyltMonthSummaries>[number];
  ...
  return (
    <div className="space-y-10">
      ...
      <p className="text-sm leading-6 text-slate-500">
        ...
        {hellesyltScheduleIntegrity.lastDate
