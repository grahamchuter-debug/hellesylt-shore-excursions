...
function compareValues(
  a: HellesyltScheduleEntry,
  b: HellesyltScheduleEntry,
  key: SortKey,
): number {
...
type ShipScheduleTableProps = {
  entries: HellesyltScheduleEntry[];
};
    ...
    <div className="space-y-4">
      <label className="block">
        <span className="mb-2 block text-sm font-medium text-slate-700">
          Search Hellesylt ship schedule
        </span>
        <input
          id="schedule-search"
          type="search"
          ...
          aria-label="Search Hellesylt ship schedule"
