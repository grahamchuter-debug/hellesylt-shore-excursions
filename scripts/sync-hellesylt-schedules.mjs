...
const outPath = path.join(root, "src/data/hellesylt-cruise-schedules.generated.json");
const payload = JSON.parse(readFileSync(sourcePath, "utf8"));
const rows = (payload.rows || []).filter((r) => r.port === "hellesylt");
...
const out = {
  port: "hellesylt", portDisplayName: "Hellesylt",
