-- Hellesylt request-to-book persistence for Stripe TEST/preview.
-- Never store card data. This schema is for preview/test/prod Hellesylt bookings (no card PAN storage).
